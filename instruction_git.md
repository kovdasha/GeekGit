...
Если при слияние веток одна и та же строка записана по-разному, то возникает конфликт. VSCode демонстрирует различия и позваляет нам сам выбрать нужный вариант. Далее вручную необходимо сохранить изменения с помощью команды:

...
Удаленные репозитории - это версии проекта, которые сохранены на удаленном сервере. Доступ к удаленному репозиторию может осуществляться по интернету или по локальной сети.
